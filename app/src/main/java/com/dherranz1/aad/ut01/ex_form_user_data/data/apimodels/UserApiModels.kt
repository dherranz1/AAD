...
data class UserApiModel(val id:Int, var name:String, val username:String, val email : String, val address: AddressUserApiModel, val phone : String, val website : String, val company: CompanyUserApiModel)
